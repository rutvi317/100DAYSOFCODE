...
class App extends Component{
    ...
    {
        this.setState({
            heading: "Hope you are doing fine",
            isBannerVisible: false,
            bannerHeading: "Banner is Changed"
        })
    }

    static getDerivedStateFromProps(props, state)
    {
        console.log("getDerivedStateFromProps method", props);
    ...
    shouldComponentUpdate(nextProps, nextState){
        ...
        if(nextState.heading === "Hope you are doing great")
            return false;
        return true;
    }
    render()
